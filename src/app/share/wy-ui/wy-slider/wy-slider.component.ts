...
@Component({
  ...
  providers:[{
    provide: NG_VALUE_ACCESSOR, //注入token
...
export class WySliderComponent implements OnInit, OnDestroy, ControlValueAccessor {
  ...
  private toogleDragMoving(movable: boolean) {
